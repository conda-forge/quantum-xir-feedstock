...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/quantum-xir-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14845&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/quantum-xir-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `quantum-xir` can be installed with:

```
conda install quantum-xir
```

It is possible to list all of the versions of `quantum-xir` available on your platform with:
